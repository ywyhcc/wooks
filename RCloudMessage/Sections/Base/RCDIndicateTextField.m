...
//初始化
- (void)initialize {
    self.lineColor = [FPStyleGuide lightGrayTextColor];
    ...
    [self addConstraints:[NSLayoutConstraint
                             constraintsWithVisualFormat:
                                 @"H:|-0-[_indicateInfoLabel(<=100)]-10-[_textField(>=150)]-10-[_indicateIcon(9)]-10-|"
                                                 options:0
                                                 metrics:nil
                                                   views:subviews]];
}
...
- (UILabel *)indicateInfoLabel {
    if (_indicateInfoLabel == nil) {
        ...
        _indicateInfoLabel.textColor = [UIColor blackColor];
