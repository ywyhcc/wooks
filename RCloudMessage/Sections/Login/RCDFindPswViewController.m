...
- (void)textFieldDidChange:(UITextField *)textField {
    if (textField.tag == UserTextFieldTag) {
        ...
        UIColor *color = [FPStyleGuide weichatGreenColor];
        if (!enable) {
...
- (void)btnDoneClicked:(id)sender {
    ...
    if (_passwordTextField.text != _rePasswordTextField.text) {
    ...
    __weak typeof(self) ws = self;
    NSDictionary *dic = @{@"telphone":phone,@"newPassword":userPwd,@"tryCode":vCode};
    
    [SYNetworkingManager requestPUTWithURLStr:FinePassword paramDic:dic success:^(NSDictionary *data) {
        rcd_dispatch_main_async_safe(^{
...
- (void)setLayout {
    ...
    NSDictionary *inputViews =
        NSDictionaryOfVariableBindings(_verificationCodeField, _pswMsgLb,  _phoneTextField,
                                       _passwordTextField,_rePasswordTextField, _loginButton, _vCodeTimerLb, _sendCodeButton);
    ...
    NSArray *inputViewConstraints = [[[[[[[
        ...
        arrayByAddingObjectsFromArray:
            [NSLayoutConstraint constraintsWithVisualFormat:
                                    @"V:|[_phoneTextField(60)]-[_verificationCodeField(50)]-["
                                    @"_passwordTextField(55)]-["
                                    @"_rePasswordTextField(55)]-[_loginButton(50)]"
                                                    options:0
                                                    metrics:nil
                                                      views:inputViews]]
...
- (RCDIndicateTextField *)phoneTextField {
    if (!_phoneTextField) {
        ...
        if (_phoneTextField.textField.text.length > 0) {
            [_phoneTextField.textField setFont:[UIFont fontWithName:@"Heiti SC" size:20.0]];
        }
    }
