...
//    NSDictionary *params = @{@"userInfoId":[ProfileUtil getUserProfile].userInfoID,@"gender":[NSString stringWithFormat:@"%ld",(long)self.selectedGender]};
...
//    }];
    ...
    [RCDUserInfoManager setGender:[NSString stringWithFormat:@"%ld",(long)self.selectedGender]
