...
+ (void)getUserInfo:(NSString *)userId anotherUserID:(NSString *)otherId complete:(void (^)(RCDUserInfo *userInfo))completeBlock;
...
+ (void)getApplyList:(void (^)(NSArray<RCDFriendInfo *> *friendList))completeBlock;

+ (void)getFriendList:(void (^)(NSArray<RCDFriendInfo *> *friendList))completeBlock;
+ (void)getMailFriendList:(void (^)(NSArray<RCDFriendInfo *> *friendList))completeBlock;
