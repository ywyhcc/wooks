...
- (UIButton *)conversationButton {
    if (!_conversationButton) {
        UIImage *img = [UIImage imageNamed:@"chat_start"];
        _conversationButton = [[UIButton alloc] init];
        _conversationButton.backgroundColor = [UIColor whiteColor];//RCDDYCOLOR(0x0099ff, 0x007acc);
        _conversationButton.translatesAutoresizingMaskIntoConstraints = NO;
        [_conversationButton setImage:[img scaleImageToSize:CGSizeMake(20, 20)] forState:UIControlStateNormal];
        ...
        [_conversationButton setTitleColor:[UIColor colorWithHex:0x5a5ca0] forState:UIControlStateNormal];
        _conversationButton.layer.masksToBounds = YES;
        _conversationButton.layer.cornerRadius = 5.f;
        _conversationButton.imageEdgeInsets = UIEdgeInsetsMake(0, 0 - 10 / 2, 0, 0 + 10 / 2);
        _conversationButton.titleEdgeInsets = UIEdgeInsetsMake(0, 0 + 10 / 2, 0, 0 - 10 / 2);
    }
...
- (UIButton *)audioCallButton {//
    if (!_audioCallButton) {
        ...
        [_audioCallButton setTitleColor:[UIColor colorWithHex:0x5a5ca0] forState:UIControlStateNormal];
        _audioCallButton.translatesAutoresizingMaskIntoConstraints = NO;
        UIImage *img = [UIImage imageNamed:@"voice_start"];
        [_audioCallButton setImage:[img scaleImageToSize:CGSizeMake(20, 20)] forState:UIControlStateNormal];
        _audioCallButton.imageEdgeInsets = UIEdgeInsetsMake(0, 0 - 10 / 2, 0, 0 + 10 / 2);
        _audioCallButton.titleEdgeInsets = UIEdgeInsetsMake(0, 0 + 10 / 2, 0, 0 - 10 / 2);
...
- (UIButton *)videoCallButton {
    if (!_videoCallButton) {
        ...
        UIImage *img = [UIImage imageNamed:@"video_start"];
        [_videoCallButton setImage:[img scaleImageToSize:CGSizeMake(20, 20)] forState:UIControlStateNormal];
        _videoCallButton.imageEdgeInsets = UIEdgeInsetsMake(0, 0 - 10 / 2, 0, 0 + 10 / 2);
        _videoCallButton.titleEdgeInsets = UIEdgeInsetsMake(0, 0 + 10 / 2, 0, 0 - 10 / 2);
        _videoCallButton.translatesAutoresizingMaskIntoConstraints = NO;
        [_videoCallButton setTitleColor:[UIColor colorWithHex:0x5a5ca0] forState:UIControlStateNormal];
