...
//    RCDFriendInfo *user = self.friends[indexPath.row];
//    if (user.status == RCDFriendStatusDelete || user.status == RCDFriendStatusIgnore || user.status == RCDFriendStatusAgree) {
//        return;
//    }
//    BOOL exist = NO;
//
//    for (NSString *friendID in self.agreeArray) {
//        if ([friendID isEqualToString:user.stAccount]) {
//            exist = YES;
//        }
//    }
//
...
//        [self.agreeArray removeObject:user.stAccount];
//    }
//    else{
//        [tableView selectRowAtIndexPath:indexPath animated:YES scrollPosition:UITableViewScrollPositionMiddle];
//        [self.agreeArray addObject:user.stAccount];
//    }
//
