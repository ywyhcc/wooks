...
+ (void)getGroupMembersNoFMDB:(NSString *)groupId complete:(void (^)(NSArray<RCDGroupMember *> *memberList))complete{
    [RCDGroupAPI getGroupMembers:groupId
    complete:^(NSArray<RCDGroupMember *> *_Nonnull memberList) {
        if (memberList) {
            NSMutableArray *memberIdList = [NSMutableArray array];
            for (RCDGroupMember *user in memberList) {
                [memberIdList addObject:user];
            }
            if (complete) {
...
+ (void)getGroupManagersFromServer:(NSString *)groupId complete:(void (^)(NSArray<NSString *> *memberIdList))complete{
